...
#file = open("ward_med_tpa.csv", "w")

book = xlswriter.Workbook("export.xlsx")
...
attachmentname = 'F:\pyora\export.xlsx.csv' #path to an attachment, if you wish
