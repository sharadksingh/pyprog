###################################################
# Program Name: monthly_zemployee_TEST.py
###################################################
'''
...
cur  = conn.cursor()
#cur.execute("select nvl(zstno,' ') zstno, nvl(zspno,' ') zspno, nvl(zfname,' ') zfname, nvl(zmname,' ') zmname, nvl(zlname,' ') zlname, nvl(zgrade,' ') zgrade, nvl(gradedesc,' ') gradedesc, nvl(zdeptcd,' ') zdeptcd, nvl(zdeptcd1,' ') persdepcd, nvl(zdept,' ') zdept, nvl(zdept1,' ') zdept1,nvl(zdor,' ') zdor, zmobile, zphone1, ' ') zphone1, nvl(replace(zphone2,0),' ') zphone2, nvl(zemail,' ') zemail, nvl(zaddl1,' ') zaddl1, nvl(zaddl2,' ') zaddl2, nvl(zaddl3,' ') zaddl3, nvl(zaddr4,' ') zaddr4, ltrim(replace(zacno,'-'),'0') zacno, nvl(zroll,' ') zroll, nvl(dob,' ') dob, nvl(doj,' ') doj, nvl(dobsl,' ') dobsl, nvl(dos,' ') dos, nvl(TO_CHAR(sep_reasoncd),' ') sep_reasoncd  from zempdtl where zroll='Y' order by zstno")
#cur.execute("select nvl(zstno,'') zstno, nvl(zspno,'') zspno, nvl(zfname,'') zfname, nvl(zmname,'') zmname, nvl(zlname,'') zlname, nvl(zgrade,'') zgrade, nvl(gradedesc,'') gradedesc, nvl(zdeptcd,'') zdeptcd, nvl(replace(zdeptcd1,''),'') persdepcd, nvl(zdept,'') zdept, nvl(zdept1,'') zdept1,nvl(zdor,'') zdor, zmobile, zphone1, zphone2, nvl(zemail,'') zemail, nvl(zaddl1,'') zaddl1, nvl(zaddl2,'') zaddl2, nvl(zaddl3,'') zaddl3, nvl(zaddr4,'') zaddr4, nvl(zacno,'') zacno, nvl(zroll,'') zroll, nvl(dob,'') dob, nvl(doj,'') doj, nvl(dobsl,'') dobsl, nvl(dos,'') dos, nvl(TO_CHAR(sep_reasoncd),'') sep_reasoncd  from zempdtl where zroll='Y' order by zstno")
#cur.execute("select nvl(zstno,' ') zstno, nvl(zspno,' ') zspno, nvl(zfname,' ') zfname, nvl(zmname,' ') zmname, nvl(zlname,' ') zlname, nvl(zgrade,' ') zgrade, nvl(gradedesc,' ') gradedesc, nvl(zdeptcd,' ') zdeptcd, nvlzdeptcd1,' ') persdepcd, nvl(zdept,' ') zdept, nvl(zdept1,' ') zdept1,nvl(zdor,' ') zdor, zmobile, zphone1, zphone2, nvl(zemail,' ') zemail, nvl(zaddl1,' ') zaddl1, nvl(zaddl2,' ') zaddl2, nvl(zaddl3,' ') zaddl3, nvl(zaddr4,' ') zaddr4, nvl(zacno,' ') zacno, nvl(zroll,' ') zroll, nvl(dob,' ') dob, nvl(doj,' ') doj, nvl(dobsl,' ') dobsl, nvl(dos,' ') dos, nvl(TO_CHAR(sep_reasoncd),' ') sep_reasoncd  from zempdtl where zroll='Y' order by zstno")
#cur.execute("select nvl(zstno,' ') zstno, nvl(zspno,' ') zspno, nvl(zfname,' ') zfname, nvl(zmname,' ') zmname, nvl(zlname,' ') zlname, nvl(zgrade,' ') zgrade, nvl(gradedesc,' ') gradedesc, nvl(zdeptcd,' ') zdeptcd, nvl(replace(zdeptcd1,' '),' ') persdepcd, nvl(zdept,' ') zdept, nvl(zdept1,' ') zdept1,nvl(zdor,' ') zdor, nvl(zmobile,' '), nvl(zphone1,' '), nvl(zphone2, ' '), nvl(zemail,' ') zemail, nvl(zaddl1,' ') zaddl1, nvl(zaddl2,' ') zaddl2, nvl(zaddl3,' ') zaddl3, nvl(zaddr4,' ') zaddr4, nvl(zacno,' ') zacno, nvl(zroll,' ') zroll, nvl(dob,' ') dob, nvl(doj,' ') doj, nvl(dobsl,' ') dobsl, nvl(dos,' ') dos, nvl(TO_CHAR(sep_reasoncd),' ') sep_reasoncd  from zempdtl where zroll='Y' order by zstno")
