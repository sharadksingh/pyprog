###############################################################################
'''
   Program Name: adm_bsl_grntr_email.py
   Output File Generated is: F:\pyora\adm_bsl_guarantor_list.csv
   Table Used: adm_edpgrt, emp_master, ward_admission_vw, emp_dep_code
   Scheduler: runs from the scheduler BGH_BILL_DETAILS_MM
   This Program sends the BSL Guatantor Data on Monthly basis 
...
file = open(r"F:\pyora\adm_bsl_guarantor_list.csv", "w")
...
filename = r"F:\pyora\adm_bsl_guarantor_list.csv"  # In same directory as script
...
dest_fname1 = (r"F:\pyora\bgh\bgh_arch\adm_bsl_guarantor_list.csv."+timestamp )
shutil.copy(r"F:\pyora\adm_bsl_guarantor_list.csv", dest_fname1)
os.remove(r"F:\pyora\adm_bsl_guarantor_list.csv")
###############################################################################
