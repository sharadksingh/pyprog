...
file = open("ward_med_head.csv", "w")

#for col in cur.description:
#       file.write(col[0]+'\n')

#cur2.execute("select staff_no minno, to_char(admdate,'dd/mm/rr') admdate, (hospno||'/'||hospyr) hospno, pat_name, pat_sex, to_char(pat_age) pat_age, pat_local_add, pat_admit_unit, pat_adm_doc, nvl(pat_provdiag,'XX') provdiag from ward_admission_vw where category='94' and admdate=trunc(sysdate)-1")
...
'''
attachmentname = 'F:\pyora\ward_med_head.csv' #path to an attachment, if you wish
